$(document).ready(function() {
  ...
  magic8Ball.answerList = ["Absolutely", "Maybe", "Without a doubt", "Meh", "No way, Jose", "Yes – definitely", "Uncertain", "There is a good chance", "In your dreams", "Furgedaboutit"];
...
magic8Ball.askQuestion = function(question) {
	...
	var randomAnswerArray = randomNumber * this.answerList.length;
